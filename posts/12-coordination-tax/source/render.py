...
used to check that the chart and the five tax rows stay legible at LinkedIn
mobile-feed size.
...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        # Guard against silent clipping: the canvas and every overflow:hidden
        # panel must contain their content exactly.
        overflow = page.evaluate(
            "() => ['.canvas', '.chart', '.sources'].map(sel => {"
