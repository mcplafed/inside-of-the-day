# Inside of the Day - series plan

## Editorial promise

One sharply framed, evidence-backed operating insight per post. Each post must give readers a mechanism they can apply, not just an opinion about AI.

## Publication order

| # | Topic | Core insight | Status |
|---:|---|---|---|
| 1 | Sonnet 5 high vs Opus 4.8 low | Choose the operating point: model x effort x harness. More effort is not automatically better. | scheduled |
...
| 13 | How often does your loop go out of control? | An autonomous loop can be productive and out of control at once. Track the net backlog delta, not the commit count: discovery that outruns delivery is a failure mode even when every finding is real. | draft |
...
- Publication scripts and secrets remain outside this repository. This repository is the canonical source for content and assets.

## Cadence

The initial launch sequence is one post per weekday. Reassess the cadence after post #4 using actual reach and discussion quality rather than assumptions.
